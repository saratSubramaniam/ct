...
<div id="content">
    ...
    <div id="left">
        ...
        <div id='newsbox' class="box-gris">
            <h1>
                <?php echo __("News", 'default')?>
            </h1>
            <?php foreach($rows as $row):?>

            <h2>
                <a href="<?php echo site_url('news/' . $row['uri'])?>" class="more">
                    <?php echo $row['title']?>
                </a>
            </h2>
            <?php if ($row['image']): ?>
            <img src="<?php echo site_url('media/images/s/' . $row['image']['file'])?>" />
            <?php endif; ?>
            <?php echo strip_tags($row['summary']) ?>
            <a href="<?php echo site_url('news/' . $row['uri'])?>" class="more">
                <?php echo __("More", "default")?>&gt;&gt;</a>
            <div class="clear"></div>
            <?php endforeach;?>
        </div>
        <?php endif; ?>
    ...
    <div id="right">
        <div id="login">
            ...
            <form id="homelogin" name="login" method="post" class="homelogin" action="<?php echo site_url('member/login');?>">
            ...
            <a href="<?php echo site_url('member/adino') ?>">
                <?php echo __("Lost password?", "default")?>
            </a> |
            <a href="<?php echo site_url('member/signup');?>">
                <?php echo __("Sign up", "default") ?>
            </a>
            <?php else : ?>
            <?php echo __("Logged in:", "default") . " " . $this->user->username ?><br />
            <a href="<?php echo site_url('member/profile') ?>">
                <?php echo __("Change password", "default")?>
            </a> |
            <a href="<?php echo site_url('member/logout') ?>">
                <?php echo __("Sign out", "default") ?>
            </a>
            <?php endif; ?>
        </div>
