...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir.$this->system->theme ?>/style/stylesheet.css" type="text/css" media="screen" charset="utf-8" />
    <link rel="stylesheet" href="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir.$this->system->theme ?>/style/lightbox.css" type="text/css" media="screen" charset="utf-8" />
    <!--[if IE]>
		<link rel="stylesheet" href="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir.$this->system->theme ?>/style/iefix.css" type="text/css" media="screen" charset="utf-8" />
	<![endif]-->
    <script src="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir.$this->system->theme ?>/javascript/jquery-1.3.2.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url()?>application/views/<?php echo $this->system->theme_dir.$this->system->theme ?>/javascript/sitelib.js" type="text/javascript"></script>
    <?php $this->plugin->do_action('header');?>
    <script type="text/javascript">
        $(document).ready(function() {
            $("a.delete").click(function() {
                if (confirm("<?php echo addslashes(__("
                        Confirm delete ? ", "
                        default "))?>")) {
