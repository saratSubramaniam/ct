 <section class="content-area">
                   ...
                   <div class="top_site_main thim-parallax-image" style="background-image: url('http://charitywp.thimpress.com/demo-3/wp-content/themes/charitywp/images/page_top_image.jpg'); background-position: 0px -68.5px;" data-stellar-background-ratio="0.5">
...
<div class="page-title-wrapper">
	<div class="banner-wrapper container article_heading">
	    <div class="row">
	        <div class="col-xs-6">
	            <h1 class="heading__primary"><?php echo $page['title']?></h1> </div>
	            <?php $this->plugin->do_action('page_pre_content', $page['id']); ?>
	        <div class="col-xs-6">
	            <ul id="thim_breadcrumbs" class="thim-breadcrumbs" itemscope="" itemtype="http://schema.org/BreadcrumbList">
	                <li class="item-home" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a itemprop="item" class="bread-link bread-home" href="<?php echo base_url()?>" title="Home"><span itemprop="name">Home</span></a></li>
	                <li class="separator separator-home"> </li>
	                <li class="item-current item-555" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><span itemprop="name" class="bread-current bread-555"><?php echo $page['title']?></span></li>
	            </ul>
	        </div>
	    </div>
	</div>
