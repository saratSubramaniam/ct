<div class="leftmenu">
    ...
    <h1 id="pageinfo">
        <?php  echo __("Category information", $module)?>
    </h1>
...
<div class="content slim">
    <h1 id="edit">
        <?php  echo __("Add new category", $module)?>
    </h1>

    <form enctype="multipart/form-data" class="edit" action="<?php  echo site_url('admin/campaigns/category/save')?>" method="post" accept-charset="utf-8">
        ...
        <ul>
            ...
            <li>
                <a href="<?php  echo site_url('admin/campaigns/category')?>" class="input-submit last">
		...
		<option value="1" <?php echo (($row['status']==1)?"selected":"")?>><?php  echo __("Active", $module)?></option>
		<option value="0" <?php echo (($row['status']==0)?"selected":"")?>><?php  echo __("Suspended", $module)?></option>
		</select><br />

            <label for="desc"><?php echo __("Description", $module)?>:</label>
