...
<div class="content slim">
    ...
    <form class="settings" action="<?php  echo site_url('admin/campaigns/settings/save')?>" method="post" accept-charset="utf-8">
        ...
        <p>
            <?php  echo __("Change the settings for the campaigns module", $module);?>
        </p>
