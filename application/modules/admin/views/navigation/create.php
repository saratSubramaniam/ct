...
<div class="leftmenu">
	...
	<ul id="tabs" class="quickmenu">
		<li><a href="#one"><?php echo __("Navigation item", $module)?></a></li>
	</ul>
...
<h1 id="navigation"><?php echo __("Create/Edit an item", $module)?></h1>
...
<form class="settings" action="<?php echo site_url('admin/navigation/save')?>" method="post" accept-charset="utf-8">
		...
		<ul>
			...
			<li><a href="<?php echo site_url('admin/navigation')?>" class="input-submit last"><?php echo __("Cancel", $module)?></a></li>
		</ul>
		...
		<div id="one">
			...
			<label for="uri"><?php echo __("Target", $module)?>: </label>
			...
			<label for="status"><?php echo __("Status", $module)?>:</label>
				<select name="status" class="input-select" id="status">
					<option value='1' <?php if ($nav['active'] == '1'):?>selected='selected' <?php endif;?>><?php echo __("Active", $module)?></option>
					<option value='0' <?php if ($nav['active'] == '0'):?>selected='selected' <?php endif;?>><?php echo __("Disabled", $module)?></option>
				</select><br />
